...
export default function CompanyAlertDetail() {
  ...
  // 프리셋 등록 여부를 묻는 함수 (기업 알림용)
  const showPresetRegistrationAlertForCompany = (conditions: any[]) => {
    showAlert({
      title: "프리셋 등록",
      ...
      buttons: [
        {
          ...
          style: "cancel",
          onPress: () => {
            // 알림 추가 페이지와 기업 선택 페이지를 닫고 기업 상세 페이지로 이동
  ...
  const handleSave = async () => {
    try {
      ...
      console.log("🤖 [기업 알림 추가] AI 피드백:", aiFeedback || "(없음)");
            ...
            onPress: () => {
              ...
              setTimeout(() => {
                ...
                if (aiFeedback) {
                    ...
                    buttons: [
                      {
                        ...
                        onPress: () => {
                          ...
                          setTimeout(() => {
                            // 3단계: 프리셋 등록 여부 확인
                            showPresetRegistrationAlertForCompany(
                              mergedConditions
                            );
                          }, 100);
                        },
                  ...
                  showPresetRegistrationAlertForCompany(mergedConditions);
                }
              }, 100);
            },
          },
