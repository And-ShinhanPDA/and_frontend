...
const PRESET_DESCRIPTIONS: { [key: string]: string } = {
  ...
  "폴 튜더 존스":
    "이 프리셋은 전설적인 매크로 트레이더 폴 튜더 존스의 전략을 반영합니다. 급격한 시장 변동성과 위기 상황에서의 기회를 포착하는 것을 목표로 합니다.",
  "마이클 버리":
    "이 프리셋은 영화 '빅쇼트'의 주인공 마이클 버리의 역발상 투자 전략을 적용합니다. 시장이 과도하게 하락한 저평가 종목을 발굴하는 것을 목표로 합니다.",
  "추세 추종":
